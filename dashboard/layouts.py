            ...
            [
                ...
                html.Div(
                    [
                        ...
                        html.Br(),
                        html.Label("Custom hour"),
                        dash_daq.NumericInput(id="sensor-hour", value=0, min=0, max=23, persistence=True),
                        html.Label("Custom minute"),
                        dash_daq.NumericInput(id="sensor-minute", value=0, min=0, max=59, persistence=True),
                        html.Label("Custom second"),
                        dash_daq.NumericInput(id="sensor-second", value=0, min=0, max=59, persistence=True),
                        html.Br(),
                        html.Br(),
